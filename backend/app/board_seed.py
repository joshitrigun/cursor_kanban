...
_SEED_CARDS: dict = {
    ...
    "card-d3-1": {
        "id": "card-d3-1",
        "title": "Granville Island Public Market breakfast",
        "details": "Start with pastries, coffee, and market browsing before the city day gets busy.",
        "status": "shortlisted",
        "start_time": "09:00",
    ...
    "card-d3-2": {
        "id": "card-d3-2",
        "title": "Stanley Park seawall and totem poles",
        "details": "Walk or bike a family-friendly section of the seawall, then stop at the totem poles for photos.",
        "status": "shortlisted",
        "start_time": "11:00",
    ...
    "card-d3-3": {
        "id": "card-d3-3",
        "title": "Gastown dinner and waterfront walk",
        "details": "Choose a casual dinner near Gastown, then walk toward Canada Place if weather is good.",
        "status": "researching",
        "start_time": "18:00",
        "location": "Gastown",
        "ai_tag": "Food",
    ...
    "card-d4-1": {
        "id": "card-d4-1",
        "title": "Canada Day waterfront events",
        "details": "Check the official schedule for family-friendly Canada Day programming near the waterfront.",
        "status": "researching",
        "start_time": "10:30",
    ...
    "card-d4-2": {
        "id": "card-d4-2",
        "title": "Lunch near Coal Harbour",
        "details": "Find an easy lunch option that avoids long Canada Day lines.",
        "status": "idea",
        "start_time": "13:00",
    ...
    "card-d4-3": {
        "id": "card-d4-3",
        "title": "World Cup match-watch option",
        "details": "Optional evening match-watch plan if a game overlaps. Keep it easy to skip for non-soccer plans.",
        "status": "idea",
        "start_time": "19:00",
        "location": "Vancouver",
        "ai_tag": "World Cup",
    ...
    "card-d5-1": {
        "id": "card-d5-1",
        "title": "Science World or Museum of Anthropology",
        "details": "Choose based on weather and family energy. Science World is easier for a rainy or kid-focused day.",
        "status": "shortlisted",
        "start_time": "10:00",
        "location": "Vancouver",
        "ai_tag": "Activity",
        "trip_date": "2026-07-02",
        "suggested_by": "Shraddha",
    },
    "card-d5-2": {
        "id": "card-d5-2",
        "title": "Richmond night market dinner plan",
        "details": "Confirm hours and tickets. Good option for a food-heavy family evening.",
        "status": "researching",
        "start_time": "18:00",
    ...
    "card-d5-3": {
        "id": "card-d5-3",
        "title": "Rainy-day backup list",
        "details": "Keep indoor options ready: aquarium, Science World, mall, or a relaxed cafe afternoon.",
        "status": "idea",
        "location": "Vancouver",
        "ai_tag": "Activity",
        "trip_date": "2026-07-02",
    ...
    "card-d6-1": {
        "id": "card-d6-1",
        "title": "Pack, checkout, and load car",
        "details": "Check rooms for chargers, passports, souvenirs, and snacks before checkout.",
        "status": "confirmed",
        "start_time": "09:00",
        "location": "Hotel",
        "ai_tag": "Lodging",
    ...
    "card-d6-2": {
        "id": "card-d6-2",
        "title": "Queen Elizabeth Park lunch stop",
        "details": "Easy final Vancouver stop with gardens, skyline views, and nearby lunch options.",
        "status": "shortlisted",
        "start_time": "12:00",
    ...
    "card-d6-3": {
        "id": "card-d6-3",
        "title": "Drive home with snack break",
        "details": "Leave after lunch and plan one low-stress break on the way home.",
        "status": "booked",
        "start_time": "14:30",
        "location": "Vancouver",
        "ai_tag": "Transport",
